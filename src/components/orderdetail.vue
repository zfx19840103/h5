<template>
    <div class="ms_content">
        <div v-if="detailType == 1" class="shopClass">
            <div class="detailTip">
            ...
            <div class="detailowner">
                ...
                <p class="detailowner_address">
                    <span>
                        {{info.snapshoot_cnt.receive_info.province}}
                        {{info.snapshoot_cnt.receive_info.city}} {{info.snapshoot_cnt.receive_info.area}}
                        {{info.snapshoot_cnt.receive_info.detailAddress}}
                    </span>
                </p>
            ...
            <div
                v-bind:class="info.snapshoot_cnt.invoice_info.invoice_type == 2 ? 'invoice' : 'invoice gren'"
                v-if="info.snapshoot_cnt.is_invoice == 1"
            >
                <h3>发票</h3>
                <p>
                    <span>发票抬头</span>
        ...
        <div v-else class="selfClass">
            ...
            <div class="detailowner">
                ...
                <div class="areaDetail">
                    ...
                    <div>
                        <span>{{info.snapshoot_cnt.receive_info.detailAddress}}</span>
                    </div>
                </div>
                <!-- <p style="font-size: 16px;">
              <span>取件人邮箱:@bytedance.com{{info.snapshoot_cnt.receive_info.name}}</span>
                </p>-->
                <!-- <p class="detailowner_address"><span>头条海淀xx楼工区</span><span>{{info.snapshoot_cnt.receive_info.province}} {{info.snapshoot_cnt.receive_info.city}} {{info.snapshoot_cnt.receive_info.area}} {{info.snapshoot_cnt.receive_info.detailAddress}}</span></p> -->
            </div>
            <div class="order">
                <div
                    class="orderh"
            ...
            <div class="timeTiShi">当日16：00后下单，次日12：00-19：00自提</div>
            <div class="ordernews">
                <h3>订单信息：</h3>
                <p>
                    <span>订单编号：</span>
...
export default {
    data() {
        return {
            ...
            orderloadingtime_zt: !!localStorage.getItem("orderloadingtime_zt")
                ? localStorage.getItem("orderloadingtime_zt")
                : 0,
            alertBox: {
                visible: false,
                tip: ""
    ...
    created() {
        ...
        if (
            (localStorage.getItem("order_isload") == 1 || localStorage.getItem("order_isload_zt") == 1) &&
            this.$route.query.myorder != 1
        ) {
            this.pollpay();
        } else {
    ...
    methods: {
        ...
        paycreateFunc() {
            ...
            if (that.detailType == 1) {
                ...
                localStorage.removeItem("order_loading_zt");
                ...
                that.timeFunc = setTimeout(function() {
                    ...
                    if (t <= n) {
                        ...
                        if (t > 0) {
                            ...
                            that.orderloadingtime_zt = t;
                        }

                        if (that.detailType == 1) {
                            localStorage.setItem("orderloadingtime", t);
                        } else {
                            localStorage.setItem("orderloadingtime_zt", t);
                        }
                        t += 1;
