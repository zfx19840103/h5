  ...
  <div class="ms_content">
    <div v-if="detailType == 1" class="shopClass">
      ...
      <div class="detailowner">
        ...
        <p class="detailowner_address"><span>{{info.snapshoot_cnt.receive_info.province}}
            {{info.snapshoot_cnt.receive_info.city}} {{info.snapshoot_cnt.receive_info.area}}
            {{info.snapshoot_cnt.receive_info.detailAddress}}</span></p>
      ...
      <div class="ordernews">
        ...
        <p>
          <span>完成时间：</span>
          <em v-if="!!info.snapshoot_cnt.success_time">{{info.snapshoot_cnt.success_time|dateformat('YYYY-MM-DD HH:mm:ss')}}</em>
          <em v-else></em>
        </p>
      </div>
