        ...
        <div class="ms_content">
            ...
            <div class="detailowner">
              ...
              <div class="areaDetail">
                ...
                <div><span>头条海淀xx楼工区</span><span>{{info.snapshoot_cnt.receive_info.province}} {{info.snapshoot_cnt.receive_info.city}} {{info.snapshoot_cnt.receive_info.area}} {{info.snapshoot_cnt.receive_info.detailAddress}}</span></div>
              </div>
