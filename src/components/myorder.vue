                    ...
                    <li v-for="(item, index) in myorderData.list1" :key="index">
                        ...
                        <div class="bottom">
                            ...
                            <div v-if="item.usage_scenario == 'bytemoon_pay'">
                                ...
                                <button
                                    v-if="(item.order_status == 5 || item.order_status == 4) && (item.invoice_status == 1 || item.invoice_status == 2 || item.invoice_status == 4)"
                ...
                list1: [
                    {
                        ...
                        user_id: 10,
                        out_biz_code: "10_16009509327992608",
                        order_code: "2009509322028w715",
                        pay_req_code: "701c6c64-fe62-11ea-945a-00163e0bb9a2",
                        snapshoot_cnt: {
                            out_biz_code: "10_16009509327992608",
                            sku_list: [
                                {
                            ...
                            pay_method: "2",
                            receive_info: {
                                email: "asdfasdf@bytedance.com",
                                detailAddress: "第一个楼"
                            },
                            is_invoice: "0",
                            pathway: "2",
                            orderdes: "",
                            usage_scenario: "bytemoon_self",
                            itemCode: "MA0000001",
                            warehouseCode: "001",
                            user_id: 10,
                            session_id:
                                "bOybPm2ilBmUU5PcCLCeTUBR404uKJpnzeEaaV3S",
                            pay_expired_at: 1600951232,
                            order_code: "2009509322028w715",
                        ...
                        pay_status: 1,
                        order_status: 5,
                        created_at: "2020-09-24T12:35:32.000000Z",
                        updated_at: "2020-09-24T12:41:02.000000Z",
                        deleted_at: null,
                        logistics_name: "顺丰",
                        user_email: "fangxu.zhang@tsingglobal.com",
                        mail_no: ""
                    },
                    {
                        invoice_status: 0,
    ...
    methods: {
        ...
        invoiceshow(item) {
            ...
            let data = {
                ...
                taxpayer_number: item.invoice_info.taxpayer_number,
        ...
        orderdetail(item) {
            let that = this;
            if (item.usage_scenario == "bytemoon_self") {
                // 自提
...
.zitiImg {
    ...
    bottom: 35px;
    left: 85px;
    background-image: url(../assets/img/ziti.png);
