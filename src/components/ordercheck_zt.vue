    ...
    <div v-bind:class="{ 'payloading': payloading }" class="ms_content">
      <div class="topcontent" v-if="!payloading">
        ...
        <div class="emailzt">
          ...
          <input type="text" @input="emailztfeinput" maxlength="50" placeholder="自取人邮箱" v-model="ordercreate.emailztfe"
            class="emailztfe">
    ...
    methods: {
      ...
      initonemoreFunc() {
        ...
        if (this.onemore == 1 && orderedit != 1) {
          ...
          this.ordercreate.emailztfe = onemoreobj.snapshoot_cnt.receive_info.email.substring(0, onemoreobj.snapshoot_cnt
            .receive_info.email.indexOf('@'));
          this.ordercreate.emailzt = onemoreobj.snapshoot_cnt.receive_info.email.substring(onemoreobj.snapshoot_cnt.receive_info
            .email.indexOf('@') + 1, onemoreobj.snapshoot_cnt.receive_info.email.length);
          ...
          this.numordersmethodobj.emailztfe = onemoreobj.snapshoot_cnt.receive_info.email.substring(0, onemoreobj.snapshoot_cnt
            .receive_info.email.indexOf('@'));
          this.numordersmethodobj.emailzt = onemoreobj.snapshoot_cnt.receive_info.email.substring(onemoreobj.snapshoot_cnt
            .receive_info.email.indexOf('@') + 1, onemoreobj.snapshoot_cnt.receive_info.email.length);
